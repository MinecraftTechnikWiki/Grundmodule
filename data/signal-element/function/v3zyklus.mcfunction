...
execute at @a[tag=EtiSigEl.3Ausgewaehlt,tag=!EtiSigEl.3Auswahl] if entity @n[distance=..30,type=minecraft:armor_stand,tag=EtiSigEl.3Empfaenger] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:2147483647,Tags:["EtiSigEl.3Alle","EtiSigEl.3Signal"]}
...
# Je nach dem welchen Wert die Partikelwolke besitzt, werden die Partikel anders gefärbt sein.
...
execute as @e[type=minecraft:area_effect_cloud,tag=EtiSigEl.3Signal] at @s facing entity @n[type=minecraft:armor_stand,tag=EtiSigEl.3Empfaenger] eyes run teleport @s ^ ^ ^0.5
...
execute as @e[type=minecraft:area_effect_cloud,tag=EtiSigEl.3Signal,scores={PZSigEl.3Wert=1..}] at @s if entity @n[distance=..1,type=minecraft:armor_stand,tag=EtiSigEl.3Empfaenger] store success entity @s Duration int 1 run scoreboard players operation @n[distance=..1,type=minecraft:armor_stand,tag=EtiSigEl.3Empfaenger] PZSigEl.3Wert = @s PZSigEl.3Wert
